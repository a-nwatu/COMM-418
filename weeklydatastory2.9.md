<h2> Weekly Data Story Assignment</h2>

<h4>Google Trends: Super Bowl LX</h4>

<p>
For this week's data story, I looked at Google Trends, a website that complies a bunch of search data and displays different data visualizations based on the results. This story focuses on Super Bowl, tracking in several different ways: interest by state, trending searches, trending searches in San Franscisco, comparative search interests about the New England Patriots and Settle Seahawks by state, interest over the week before the Super Bowl (January 22nd through January 29th), trending searches related to Bad Bunny, and interest about Bad Bunny broken down by state. Google Trends also included a "Related Searches" sectioned that features more information related to the Super Bowl Halftime Show, American Football, the NFL, and Santa Clara. 
